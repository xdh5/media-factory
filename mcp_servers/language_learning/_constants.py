...
CHINESE_PUBLISH_ACCOUNT_GROUP = "Daily Chinese Learning"
CHINESE_PUBLISH_TAGS = ["#learnchinese", "#chinesevocabulary", "#mandarinchinese", "#dailychinese"]
KOREAN_PUBLISH_ACCOUNT_GROUP = "韩语"
KOREAN_PUBLISH_TAGS = ["#学韩语", "#韩语单词", "#韩语入门", "#每日韩语"]
MATRIXMEDIA_VIDEO_PLATFORMS = ("dy", "ks", "blbl", "bjh", "tt", "sph")
...
JOB_HANDLER = "mcp_servers.language_learning.job_runner:run_job"
