...
from ._constants import VIDEO_FPS, VIDEO_RENDERER_VERSION
from ._errors import CacheError, FFmpegNotFoundError, InvalidParameterError, RenderError
from .render_shot import _probe, render_shot
...
def compose_video(
    ...
    *,
    ...
    return {
        ...
        "rendered_shots": sum(1 for item in shot_results if not item["cache_hit"]),
        "shots": shot_results,
    }
