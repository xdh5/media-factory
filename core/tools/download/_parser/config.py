...
# _parser → download → tools → core → media-factory
_PROJECT_ROOT = _PARSER_ROOT.parents[3]
VIDEO_DIR = _PROJECT_ROOT / "data" / "download" / "videos"
IMAGE_DIR = _PROJECT_ROOT / "data" / "download" / "images"
STATIC_DIR = _PROJECT_ROOT / "data" / "download"
